...
status_apotheosis_protection_vulnerable_name,Vulnerable Immunity,,,,,,,,,無力感に対する免疫,,,,
status_apotheosis_protection_vulnerable_desc,You can not have your immunities disabled from most sources.,,,,,,,,,ほとんどの情報源から、プロテクト特典を無効にすることはできない。,,,,
